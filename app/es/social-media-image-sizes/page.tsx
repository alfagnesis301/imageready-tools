...
export const metadata = createPageMetadata({
  ...
  description:
    "Consulta tamaños recomendados para Instagram, Facebook, X, LinkedIn, YouTube, TikTok y Pinterest, con una guía práctica para publicaciones, stories, miniaturas y banners.",
