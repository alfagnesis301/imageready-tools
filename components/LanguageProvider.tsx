...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    "nav.Smart Check": "Revisión inteligente",
    ...
    "nav.YouTube Thumbnail Checker": "Revisor de miniaturas",
    "nav.Alt Text Checker": "Revisor de texto alternativo",
    "nav.Metadata Checker": "Revisor de metadatos",
    "nav.Website Image Optimizer": "Optimizador para sitios web",
    "nav.Instagram Checker": "Revisor de Instagram",
    "nav.About": "Acerca de",
