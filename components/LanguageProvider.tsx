...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    "tool.defaultHeading": "Chequeo inteligente de imagen",
    "tool.defaultDescription":
    ...
    "status.Wrong aspect ratio": "Relación de aspecto incorrecta",
    "status.Too small": "Demasiado pequeña",
    "status.Not recommended": "No recomendada",
    "quality.website-blog":
      "Normalmente funciona mejor como WebP o JPG ligero con ancho suficiente para layouts responsive.",
    "quality.seo-featured": "Una imagen grande y comprimida puede ayudar a previews manteniendo la página rápida.",
    "quality.open-graph": "Usa un área focal clara porque diferentes servicios pueden recortar los previews.",
    "quality.google-discover": "Usa una fuente de alta calidad y comprime con cuidado cuando sea posible.",
    "quality.youtube-thumbnail": "Deja espacio para títulos, timestamps y overlays de interfaz.",
    "quality.instagram-post": "Ajusta la imagen a uno de los ratios comunes del feed para evitar recortes inesperados.",
    "quality.instagram-story": "Mantén detalles importantes lejos de las zonas superior e inferior de la interfaz.",
    "quality.facebook-post": "Una imagen 1.91:1 suele funcionar bien para previews de enlaces y uso amplio.",
    ...
    "quality.email-header": "Los archivos ligeros ayudan porque los clientes de email y redes varían.",
    "quality.hero-banner": "Usa suficiente ancho para pantallas grandes, luego comprime y sirve tamaños responsive.",
    ...
    "metrics.aspectRatio": "Relación de aspecto",
    ...
    "compression.svgExport":
      "La exportación raster de SVG no está activada aquí. Usa los resultados del Smart Check para una revisión básica del SVG.",
    "compression.download": "Descargar preview optimizada",
    ...
    "resize.width": "Ancho",
    "resize.height": "Alto",
    "resize.lockAspect": "Bloquear relación de aspecto",
    ...
    "metadata.altStructure": "Estructura de alt text",
    ...
    "metadata.notice":
      "Reexportar mediante Canvas normalmente elimina metadatos EXIF, pero esta app no promete una eliminación perfecta para todos los navegadores y archivos.",
    "filename.title": "Chequeo SEO del nombre: {status}",
    ...
    "home.heroTitle": "Herramienta gratuita para comprobar imágenes antes de publicar",
    "home.heroDescription":
      "Comprueba si tu imagen está lista para websites, SEO, redes sociales, miniaturas de YouTube, e-commerce, headers de email y más, de forma privada en tu navegador.",
    "home.viewSizeGuide": "Ver guía de tamaños",
    "home.checksEyebrow": "Qué revisa la herramienta",
    "home.checksTitle": "¿Qué comprueba PublishPixel?",
    "home.checksDescription":
      "La preparación de una imagen es más que un número de peso. El Smart Check combina dimensiones, ratio, formato, compresión estimada y contexto para ayudarte a decidir mejor antes de publicar.",
    ...
    "home.check.3": "Guía de nombre SEO y estructura de alt text",
    ...
    "home.differentTitle": "Más que compresión: un chequeo completo antes de publicar",
    "home.differentDescription":
    ...
    "home.contextTitle": "Chequeos según el contexto",
    "home.contextDescription":
      "Compara tu imagen con presets prácticos para blogs, previews Open Graph, miniaturas de YouTube, productos, headers de email y posts sociales.",
    ...
    "home.scoreDescription":
      "Obtén una puntuación simple con avisos claros sobre peso, dimensiones, ratio, formato, alt text, nombre de archivo y metadatos.",
    "home.speedEyebrow": "Velocidad de publicación",
    "home.readinessTitle": "Por qué importa preparar las imágenes",
    "home.readinessP1":
      "Las imágenes influyen en la velocidad, el acabado visual, los previews sociales y la primera impresión de un post o producto. Una imagen muy pesada puede ralentizar una página; una imagen pequeña o mal recortada puede verse débil en previews.",
    "home.readinessP2":
    ...
    "home.workflowSectionDescription":
      "PublishPixel combina varios chequeos de publicación en un solo flujo para revisar una imagen antes de que llegue a tu CMS, tienda, campaña o post social.",
    "home.beforeUploadTitle": "Antes de subir",
    "home.beforeUploadDescription": "Revisa dimensiones, ratio, peso y formato antes de que el archivo entre en tu sistema de publicación.",
    "home.beforeShareTitle": "Antes de compartir",
    "home.beforeShareDescription": "Prepara crops para Open Graph, miniaturas y redes sociales para que los previews se vean intencionales.",
    ...
    "home.accessibilityP1":
      "Una imagen útil debe tener propósito, un recorte legible y un plan de alt text que describa el contenido visible con honestidad. Si es decorativa, la página final debería tratarla como decorativa.",
    "home.accessibilityP2":
      "PublishPixel orienta sobre nombre de archivo y estructura de alt text sin inventar descripciones visuales. Tú mantienes control sobre el texto final.",
    ...
    "home.performanceP1":
      "Antes de publicar, revisa si el archivo pesa más de lo necesario, si las dimensiones coinciden con el layout y si WebP o JPG serían mejores formatos de exportación.",
    "home.performanceP2":
      "Las herramientas de exportación en el navegador ayudan a crear previews más ligeros para flujos comunes. En producción, conviene usar responsive images y caché.",
    "home.scoringEyebrow": "Cómo funciona la puntuación",
    "home.scoringTitle": "Explicación del Smart Image Publish Check",
    "home.scoringDescription":
      "El PublishReady Score pondera dimensiones y ratio, peso, formato recomendado y señales de calidad según el contexto. Está diseñado para guiar decisiones rápidas, no para reemplazar requisitos oficiales.",
    "home.scorePart.0": "40% dimensiones y relación de aspecto",
    ...
    "home.guidesDescription":
      "Estas guías originales explican las decisiones detrás del checker: dimensiones, metadatos, alt text, compresión, privacidad y elección de formato.",
    "home.popularEyebrow": "Presets populares",
    "home.popularTitle": "Presets de imagen populares",
    "home.presetNote": "{dimensions}; ratio recomendado {ratio}.",
    "home.privacyEyebrow": "Análisis de imagen privacy-first",
    ...
    "home.disclaimerText":
      "Los resultados son estimaciones basadas en patrones comunes de plataformas y chequeos técnicos disponibles en el navegador. Los requisitos pueden cambiar y esta herramienta no garantiza ranking SEO, aprobación ni renderizado final en servicios externos.",
    ...
    "home.faq.score.q": "¿El PublishReady Score es una puntuación oficial?",
    "home.faq.score.a":
      "No. Es una puntuación estimada basada en guías comunes de publicación, peso, dimensiones, ratio y heurísticas prácticas.",
    "home.faq.og.q": "¿Puedo usarlo para imágenes Open Graph?",
    "home.faq.og.a":
      "Sí. Elige el preset Open Graph para revisar el formato común 1200 x 630 px, peso y recomendaciones de formato.",
    "home.faq.compress.q": "¿La herramienta puede comprimir imágenes?",
    "home.faq.compress.a":
      "Sí. Tras subir una imagen raster compatible, puedes exportar una preview optimizada en JPG, WebP o PNG desde tu navegador.",
    ...
    "home.faq.formats.a":
      "La versión inicial soporta JPG, JPEG, PNG, WebP, chequeos de GIF estático y análisis básico de dimensiones SVG.",
    "home.faq.youtube.q": "¿Puedo usarlo para miniaturas de YouTube?",
    "home.faq.youtube.a":
      "Sí. El preset de YouTube revisa el tamaño común 1280 x 720 px, ratio 16:9 y recomendaciones de peso.",
    "home.faq.free.q": "¿La herramienta es gratis?",
    "home.faq.free.a":
      "Sí. La app está diseñada como una utilidad gratuita en el navegador. El soporte para AdSense está preparado, pero no se muestran anuncios sin un publisher aprobado.",
    ...
    "guide.image-alt-text.title": "Cómo escribir alt text útil para imágenes",
    "guide.image-alt-text.description": "Escribe alt text más claro para accesibilidad, contexto y mejores flujos de publicación.",
    "guide.webp-vs-jpeg-vs-png.title": "WebP vs JPEG vs PNG: qué formato de imagen usar",
    "guide.webp-vs-jpeg-vs-png.description": "Compara formatos comunes y elige un formato práctico para páginas web y previews sociales.",
    "guide.image-seo-checklist.title": "Checklist SEO de imágenes antes de publicar",
    "guide.image-seo-checklist.description": "Un checklist práctico para nombres de archivo, alt text, dimensiones, peso y previews sociales.",
    "guide.social-media-image-sizes.title": "Tamaños de imagen para redes sociales: guía práctica",
    "guide.social-media-image-sizes.description": "Prepara crops para Open Graph, YouTube, Instagram, LinkedIn, Pinterest y feeds de producto.",
