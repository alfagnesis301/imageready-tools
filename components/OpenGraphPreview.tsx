...
export default function OpenGraphPreview({
  imageUrl,
  title = "Your article title appears here",
  description = "A short preview description appears here.",
  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h3 className="text-sm font-bold text-slate-950 dark:text-white">Open Graph preview</h3>
          <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
            Simulated 1.91:1 link card crop.
          </p>
        </div>
